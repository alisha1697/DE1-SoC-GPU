...
VL_ATTR_COLD void Vfma___024root___eval_initial__TOP(Vfma___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
    IData/*31:0*/ thread_tb__DOT__unnamedblk2__DOT__i;
    thread_tb__DOT__unnamedblk2__DOT__i = 0;
    IData/*31:0*/ thread_tb__DOT__unnamedblk3__DOT__i;
    thread_tb__DOT__unnamedblk3__DOT__i = 0;
    // Body
    vlSelfRef.thread_tb__DOT__mem_A[0U] = 1U;
    vlSelfRef.thread_tb__DOT__mem_A[1U] = 2U;
    vlSelfRef.thread_tb__DOT__mem_A[2U] = 3U;
    vlSelfRef.thread_tb__DOT__mem_A[3U] = 4U;
    vlSelfRef.thread_tb__DOT__mem_A[4U] = 5U;
    vlSelfRef.thread_tb__DOT__mem_A[5U] = 6U;
    vlSelfRef.thread_tb__DOT__mem_A[6U] = 7U;
    vlSelfRef.thread_tb__DOT__mem_A[7U] = 8U;
    vlSelfRef.thread_tb__DOT__mem_A[8U] = 9U;
    vlSelfRef.thread_tb__DOT__mem_A[9U] = 0x000aU;
    vlSelfRef.thread_tb__DOT__mem_A[10U] = 0x000bU;
    vlSelfRef.thread_tb__DOT__mem_A[11U] = 0x000cU;
    vlSelfRef.thread_tb__DOT__mem_A[12U] = 0x000dU;
    vlSelfRef.thread_tb__DOT__mem_A[13U] = 0x000eU;
    vlSelfRef.thread_tb__DOT__mem_A[14U] = 0x000fU;
    vlSelfRef.thread_tb__DOT__mem_A[15U] = 0x0010U;
    thread_tb__DOT__unnamedblk2__DOT__i = 0x00000010U;
    while (VL_GTS_III(32, 0x00000100U, thread_tb__DOT__unnamedblk2__DOT__i)) {
        vlSelfRef.thread_tb__DOT__mem_A[(0x000000ffU 
                                         & thread_tb__DOT__unnamedblk2__DOT__i)] = 0U;
        thread_tb__DOT__unnamedblk2__DOT__i = ((IData)(1U) 
                                               + thread_tb__DOT__unnamedblk2__DOT__i);
    }
    vlSelfRef.thread_tb__DOT__mem_B[0U] = 1U;
    vlSelfRef.thread_tb__DOT__mem_B[1U] = 2U;
    vlSelfRef.thread_tb__DOT__mem_B[2U] = 0U;
    vlSelfRef.thread_tb__DOT__mem_B[3U] = 1U;
    vlSelfRef.thread_tb__DOT__mem_B[4U] = 0U;
    vlSelfRef.thread_tb__DOT__mem_B[5U] = 1U;
    vlSelfRef.thread_tb__DOT__mem_B[6U] = 2U;
    vlSelfRef.thread_tb__DOT__mem_B[7U] = 0U;
    vlSelfRef.thread_tb__DOT__mem_B[8U] = 1U;
    vlSelfRef.thread_tb__DOT__mem_B[9U] = 0U;
    vlSelfRef.thread_tb__DOT__mem_B[10U] = 1U;
    vlSelfRef.thread_tb__DOT__mem_B[11U] = 2U;
    vlSelfRef.thread_tb__DOT__mem_B[12U] = 2U;
    vlSelfRef.thread_tb__DOT__mem_B[13U] = 1U;
    vlSelfRef.thread_tb__DOT__mem_B[14U] = 0U;
    vlSelfRef.thread_tb__DOT__mem_B[15U] = 1U;
    thread_tb__DOT__unnamedblk3__DOT__i = 0x00000010U;
    while (VL_GTS_III(32, 0x00000100U, thread_tb__DOT__unnamedblk3__DOT__i)) {
        vlSelfRef.thread_tb__DOT__mem_B[(0x000000ffU 
                                         & thread_tb__DOT__unnamedblk3__DOT__i)] = 0U;
        thread_tb__DOT__unnamedblk3__DOT__i = ((IData)(1U) 
                                               + thread_tb__DOT__unnamedblk3__DOT__i);
    }
}
...
VL_ATTR_COLD void Vfma___024root___ctor_var_reset(Vfma___024root* vlSelf) {
    ...
    vlSelf->thread_tb__DOT__kernel_init = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 5839285912901635609ull);
