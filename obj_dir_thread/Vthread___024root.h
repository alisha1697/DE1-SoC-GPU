...
#ifndef VERILATED_VTHREAD___024ROOT_H_
#define VERILATED_VTHREAD___024ROOT_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vthread___024root final {
  public:
    ...
    CData/*0:0*/ thread_tb__DOT__dut__DOT__kernel_init;
    ...
    // INTERNAL VARIABLES
    Vthread__Syms* vlSymsp;
    const char* vlNamep;

    // CONSTRUCTORS
    Vthread___024root(Vthread__Syms* symsp, const char* namep);
    ~Vthread___024root();
    VL_UNCOPYABLE(Vthread___024root);
