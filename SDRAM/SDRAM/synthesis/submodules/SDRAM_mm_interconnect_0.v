...
module SDRAM_mm_interconnect_0 (
		...
		input  wire        gpu_mem_master_0_reset_reset_bridge_in_reset_reset, // gpu_mem_master_0_reset_reset_bridge_in_reset.reset
		input  wire [31:0] gpu_mem_master_0_avalon_master_address,             //               gpu_mem_master_0_avalon_master.address
		output wire        gpu_mem_master_0_avalon_master_waitrequest,         //                                             .waitrequest
		input  wire [3:0]  gpu_mem_master_0_avalon_master_byteenable,          //                                             .byteenable
		input  wire        gpu_mem_master_0_avalon_master_read,                //                                             .read
		output wire [31:0] gpu_mem_master_0_avalon_master_readdata,            //                                             .readdata
		output wire        gpu_mem_master_0_avalon_master_readdatavalid,       //                                             .readdatavalid
		input  wire        gpu_mem_master_0_avalon_master_write,               //                                             .write
		input  wire [31:0] gpu_mem_master_0_avalon_master_writedata,           //                                             .writedata
	...
	wire          gpu_mem_master_0_avalon_master_translator_avalon_universal_master_0_waitrequest;   // gpu_mem_master_0_avalon_master_agent:av_waitrequest -> gpu_mem_master_0_avalon_master_translator:uav_waitrequest
	wire   [31:0] gpu_mem_master_0_avalon_master_translator_avalon_universal_master_0_readdata;      // gpu_mem_master_0_avalon_master_agent:av_readdata -> gpu_mem_master_0_avalon_master_translator:uav_readdata
	wire          gpu_mem_master_0_avalon_master_translator_avalon_universal_master_0_debugaccess;   // gpu_mem_master_0_avalon_master_translator:uav_debugaccess -> gpu_mem_master_0_avalon_master_agent:av_debugaccess
	wire   [31:0] gpu_mem_master_0_avalon_master_translator_avalon_universal_master_0_address;       // gpu_mem_master_0_avalon_master_translator:uav_address -> gpu_mem_master_0_avalon_master_agent:av_address
	wire          gpu_mem_master_0_avalon_master_translator_avalon_universal_master_0_read;          // gpu_mem_master_0_avalon_master_translator:uav_read -> gpu_mem_master_0_avalon_master_agent:av_read
	wire    [3:0] gpu_mem_master_0_avalon_master_translator_avalon_universal_master_0_byteenable;    // gpu_mem_master_0_avalon_master_translator:uav_byteenable -> gpu_mem_master_0_avalon_master_agent:av_byteenable
	wire          gpu_mem_master_0_avalon_master_translator_avalon_universal_master_0_readdatavalid; // gpu_mem_master_0_avalon_master_agent:av_readdatavalid -> gpu_mem_master_0_avalon_master_translator:uav_readdatavalid
	wire          gpu_mem_master_0_avalon_master_translator_avalon_universal_master_0_lock;          // gpu_mem_master_0_avalon_master_translator:uav_lock -> gpu_mem_master_0_avalon_master_agent:av_lock
	wire          gpu_mem_master_0_avalon_master_translator_avalon_universal_master_0_write;         // gpu_mem_master_0_avalon_master_translator:uav_write -> gpu_mem_master_0_avalon_master_agent:av_write
	wire   [31:0] gpu_mem_master_0_avalon_master_translator_avalon_universal_master_0_writedata;     // gpu_mem_master_0_avalon_master_translator:uav_writedata -> gpu_mem_master_0_avalon_master_agent:av_writedata
	wire    [2:0] gpu_mem_master_0_avalon_master_translator_avalon_universal_master_0_burstcount;    // gpu_mem_master_0_avalon_master_translator:uav_burstcount -> gpu_mem_master_0_avalon_master_agent:av_burstcount
	wire          rsp_mux_src_valid;                                                                 // rsp_mux:src_valid -> gpu_mem_master_0_avalon_master_agent:rp_valid
	wire  [101:0] rsp_mux_src_data;                                                                  // rsp_mux:src_data -> gpu_mem_master_0_avalon_master_agent:rp_data
	wire          rsp_mux_src_ready;                                                                 // gpu_mem_master_0_avalon_master_agent:rp_ready -> rsp_mux:src_ready
	wire    [0:0] rsp_mux_src_channel;                                                               // rsp_mux:src_channel -> gpu_mem_master_0_avalon_master_agent:rp_channel
	wire          rsp_mux_src_startofpacket;                                                         // rsp_mux:src_startofpacket -> gpu_mem_master_0_avalon_master_agent:rp_startofpacket
	wire          rsp_mux_src_endofpacket;                                                           // rsp_mux:src_endofpacket -> gpu_mem_master_0_avalon_master_agent:rp_endofpacket
	...
	wire          gpu_mem_master_0_avalon_master_agent_cp_valid;                                     // gpu_mem_master_0_avalon_master_agent:cp_valid -> router:sink_valid
	wire  [101:0] gpu_mem_master_0_avalon_master_agent_cp_data;                                      // gpu_mem_master_0_avalon_master_agent:cp_data -> router:sink_data
	wire          gpu_mem_master_0_avalon_master_agent_cp_ready;                                     // router:sink_ready -> gpu_mem_master_0_avalon_master_agent:cp_ready
	wire          gpu_mem_master_0_avalon_master_agent_cp_startofpacket;                             // gpu_mem_master_0_avalon_master_agent:cp_startofpacket -> router:sink_startofpacket
	wire          gpu_mem_master_0_avalon_master_agent_cp_endofpacket;                               // gpu_mem_master_0_avalon_master_agent:cp_endofpacket -> router:sink_endofpacket
	...
	wire          sdram_controller_s1_agent_rp_valid;                                                // sdram_controller_s1_agent:rp_valid -> router_001:sink_valid
	wire   [83:0] sdram_controller_s1_agent_rp_data;                                                 // sdram_controller_s1_agent:rp_data -> router_001:sink_data
	wire          sdram_controller_s1_agent_rp_ready;                                                // router_001:sink_ready -> sdram_controller_s1_agent:rp_ready
	wire          sdram_controller_s1_agent_rp_startofpacket;                                        // sdram_controller_s1_agent:rp_startofpacket -> router_001:sink_startofpacket
	wire          sdram_controller_s1_agent_rp_endofpacket;                                          // sdram_controller_s1_agent:rp_endofpacket -> router_001:sink_endofpacket
	...
	wire    [0:0] sdram_controller_s1_burst_adapter_source0_channel;                                 // sdram_controller_s1_burst_adapter:source0_channel -> sdram_controller_s1_agent:cp_channel
	...
	wire          router_001_src_valid;                                                              // router_001:src_valid -> sdram_controller_s1_rsp_width_adapter:in_valid
	wire   [83:0] router_001_src_data;                                                               // router_001:src_data -> sdram_controller_s1_rsp_width_adapter:in_data
	wire          router_001_src_ready;                                                              // sdram_controller_s1_rsp_width_adapter:in_ready -> router_001:src_ready
	wire    [0:0] router_001_src_channel;                                                            // router_001:src_channel -> sdram_controller_s1_rsp_width_adapter:in_channel
	wire          router_001_src_startofpacket;                                                      // router_001:src_startofpacket -> sdram_controller_s1_rsp_width_adapter:in_startofpacket
	wire          router_001_src_endofpacket;                                                        // router_001:src_endofpacket -> sdram_controller_s1_rsp_width_adapter:in_endofpacket
	...
	wire  [101:0] sdram_controller_s1_rsp_width_adapter_src_data;                                    // sdram_controller_s1_rsp_width_adapter:out_data -> rsp_demux:sink_data
	...
	wire    [0:0] sdram_controller_s1_rsp_width_adapter_src_channel;                                 // sdram_controller_s1_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	...
	wire  [101:0] cmd_mux_src_data;                                                                  // cmd_mux:src_data -> sdram_controller_s1_cmd_width_adapter:in_data
	wire          cmd_mux_src_ready;                                                                 // sdram_controller_s1_cmd_width_adapter:in_ready -> cmd_mux:src_ready
	wire    [0:0] cmd_mux_src_channel;                                                               // cmd_mux:src_channel -> sdram_controller_s1_cmd_width_adapter:in_channel
	...
	wire    [0:0] sdram_controller_s1_cmd_width_adapter_src_channel;                                 // sdram_controller_s1_cmd_width_adapter:out_channel -> sdram_controller_s1_burst_adapter:sink0_channel
	...
	) gpu_mem_master_0_avalon_master_translator (
		.clk                    (sys_sdram_pll_sys_clk_clk),                                                         //                       clk.clk
		.reset                  (gpu_mem_master_0_reset_reset_bridge_in_reset_reset),                                //                     reset.reset
		.uav_address            (gpu_mem_master_0_avalon_master_translator_avalon_universal_master_0_address),       // avalon_universal_master_0.address
		.uav_burstcount         (gpu_mem_master_0_avalon_master_translator_avalon_universal_master_0_burstcount),    //                          .burstcount
		.uav_read               (gpu_mem_master_0_avalon_master_translator_avalon_universal_master_0_read),          //                          .read
		.uav_write              (gpu_mem_master_0_avalon_master_translator_avalon_universal_master_0_write),         //                          .write
		.uav_waitrequest        (gpu_mem_master_0_avalon_master_translator_avalon_universal_master_0_waitrequest),   //                          .waitrequest
		.uav_readdatavalid      (gpu_mem_master_0_avalon_master_translator_avalon_universal_master_0_readdatavalid), //                          .readdatavalid
		.uav_byteenable         (gpu_mem_master_0_avalon_master_translator_avalon_universal_master_0_byteenable),    //                          .byteenable
		.uav_readdata           (gpu_mem_master_0_avalon_master_translator_avalon_universal_master_0_readdata),      //                          .readdata
		.uav_writedata          (gpu_mem_master_0_avalon_master_translator_avalon_universal_master_0_writedata),     //                          .writedata
		.uav_lock               (gpu_mem_master_0_avalon_master_translator_avalon_universal_master_0_lock),          //                          .lock
		.uav_debugaccess        (gpu_mem_master_0_avalon_master_translator_avalon_universal_master_0_debugaccess),   //                          .debugaccess
		.av_address             (gpu_mem_master_0_avalon_master_address),                                            //      avalon_anti_master_0.address
		.av_waitrequest         (gpu_mem_master_0_avalon_master_waitrequest),                                        //                          .waitrequest
		.av_byteenable          (gpu_mem_master_0_avalon_master_byteenable),                                         //                          .byteenable
		.av_read                (gpu_mem_master_0_avalon_master_read),                                               //                          .read
		.av_readdata            (gpu_mem_master_0_avalon_master_readdata),                                           //                          .readdata
		.av_readdatavalid       (gpu_mem_master_0_avalon_master_readdatavalid),                                      //                          .readdatavalid
		.av_write               (gpu_mem_master_0_avalon_master_write),                                              //                          .write
		.av_writedata           (gpu_mem_master_0_avalon_master_writedata),                                          //                          .writedata
	...
	altera_merlin_master_agent #(
		...
		.USE_READRESPONSE          (0),
		.USE_WRITERESPONSE         (0)
	) gpu_mem_master_0_avalon_master_agent (
		.clk                   (sys_sdram_pll_sys_clk_clk),                                                         //       clk.clk
		.reset                 (gpu_mem_master_0_reset_reset_bridge_in_reset_reset),                                // clk_reset.reset
		.av_address            (gpu_mem_master_0_avalon_master_translator_avalon_universal_master_0_address),       //        av.address
		.av_write              (gpu_mem_master_0_avalon_master_translator_avalon_universal_master_0_write),         //          .write
		.av_read               (gpu_mem_master_0_avalon_master_translator_avalon_universal_master_0_read),          //          .read
		.av_writedata          (gpu_mem_master_0_avalon_master_translator_avalon_universal_master_0_writedata),     //          .writedata
		.av_readdata           (gpu_mem_master_0_avalon_master_translator_avalon_universal_master_0_readdata),      //          .readdata
		.av_waitrequest        (gpu_mem_master_0_avalon_master_translator_avalon_universal_master_0_waitrequest),   //          .waitrequest
		.av_readdatavalid      (gpu_mem_master_0_avalon_master_translator_avalon_universal_master_0_readdatavalid), //          .readdatavalid
		.av_byteenable         (gpu_mem_master_0_avalon_master_translator_avalon_universal_master_0_byteenable),    //          .byteenable
		.av_burstcount         (gpu_mem_master_0_avalon_master_translator_avalon_universal_master_0_burstcount),    //          .burstcount
		.av_debugaccess        (gpu_mem_master_0_avalon_master_translator_avalon_universal_master_0_debugaccess),   //          .debugaccess
		.av_lock               (gpu_mem_master_0_avalon_master_translator_avalon_universal_master_0_lock),          //          .lock
		.cp_valid              (gpu_mem_master_0_avalon_master_agent_cp_valid),                                     //        cp.valid
		.cp_data               (gpu_mem_master_0_avalon_master_agent_cp_data),                                      //          .data
		.cp_startofpacket      (gpu_mem_master_0_avalon_master_agent_cp_startofpacket),                             //          .startofpacket
		.cp_endofpacket        (gpu_mem_master_0_avalon_master_agent_cp_endofpacket),                               //          .endofpacket
		.cp_ready              (gpu_mem_master_0_avalon_master_agent_cp_ready),                                     //          .ready
	...
	SDRAM_mm_interconnect_0_router router (
		.sink_ready         (gpu_mem_master_0_avalon_master_agent_cp_ready),         //      sink.ready
		.sink_valid         (gpu_mem_master_0_avalon_master_agent_cp_valid),         //          .valid
		.sink_data          (gpu_mem_master_0_avalon_master_agent_cp_data),          //          .data
		.sink_startofpacket (gpu_mem_master_0_avalon_master_agent_cp_startofpacket), //          .startofpacket
		.sink_endofpacket   (gpu_mem_master_0_avalon_master_agent_cp_endofpacket),   //          .endofpacket
		.clk                (sys_sdram_pll_sys_clk_clk),                             //       clk.clk
		.reset              (gpu_mem_master_0_reset_reset_bridge_in_reset_reset),    // clk_reset.reset
	...
	altera_merlin_burst_adapter #(
		...
		.reset                 (gpu_mem_master_0_reset_reset_bridge_in_reset_reset),      // cr0_reset.reset
	...
	SDRAM_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_rst_0_reset (gpu_mem_master_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
